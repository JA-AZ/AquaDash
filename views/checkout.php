        ...
        if (!isset($_POST['address_id']) || empty($_POST['address_id'])) {
            ...
            try {
                ...
                $insertOrderSql = "INSERT INTO confirmed_orders 
                                (UserID, AddressID, ShippingMethod, ShippingFee, Subtotal, TotalAmount, PaymentMethod, OrderStatus, EstimatedDeliveryDate) 
                                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                $insertOrderStmt = $conn->prepare($insertOrderSql);
                $insertOrderStmt->bind_param("iisdddsss", $userID, $addressID, $shippingMethod, $shippingFee, $subtotal, $total, $paymentMethod, $orderStatus, $estimatedDeliveryDate);
                ...
                while ($item = $cartItems->fetch_assoc()) {
                    ...
                    $updateOrderSql = "UPDATE orders SET Status = 'checkout' WHERE OrderID = ?";
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <?php else: ?>
                ...
                <!-- Add New Address Form OUTSIDE the main checkout form -->
                <form method="post" action="checkout.php" id="add-address-form" style="margin-top: 20px;" autocomplete="on">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="recipient_name" name="recipient_name" required autocomplete="name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="phone_number">Phone Number</label>
                                    <input type="text" class="form-control" id="phone_number" name="phone_number" required autocomplete="tel">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="street_address">Street Address</label>
                            <input type="text" class="form-control" id="street_address" name="street_address" required autocomplete="street-address">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="barangay">Barangay</label>
                                    <input type="text" class="form-control" id="barangay" name="barangay" required autocomplete="address-level2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="province" name="province" required autocomplete="address-level1">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="postal_code">Postal Code</label>
                                    <input type="text" class="form-control" id="postal_code" name="postal_code" required autocomplete="postal-code">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
